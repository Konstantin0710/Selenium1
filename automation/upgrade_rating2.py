    ...
    while vote <= votes:
        try:
            ...
            headers = {
                ...
                'content-type': 'application/x-www-form-urlencoded',
                'user-agent': f'{useragent.random}',
                'Cookie': 'uua=843ce52f4eeaec7b9cd7c4479b6806fc; _ga_R0LEF5ZFCF=GS1.1.1661409109.1.0.1661409111.0.0.0; _ga=GA1.1.790411230.1661409109; _ga_8MQ0FGXD1P=GS1.1.1661409109.1.0.1661409111.0.0.0; _ga_R7DD899R0W=GS1.1.1661409109.1.0.1661409111.0.0.0; _ga_BJV4WPQPYC=GS1.1.1661409109.1.0.1661409111.0.0.0',
            }
...
# up_rating(1923)
for _ in range(3):
    Thread(target=up_rating, args=(4682,)).start()